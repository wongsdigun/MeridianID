...
class medoo
{
	...
	protected $username = 'utakkus1_atnceu';

	protected $password = 'uta49077';
	...
	protected $database_name = 'utakkus1_akdb';

	//END PRODUCTION

	//DEVELOPMENT// For MySQL, MariaDB, MSSQL, Sybase, PostgreSQL, Oracle
	// protected $server = 'localhost';
	...
	// protected $database_name = 'db_rikues';
